...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <span class="breadcrumb"><a href="#">Home</a> / Basic Buffet Menu A</span>
          <h3>Basic Buffet Menu A</h3>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div style="width: 500px;" class="section-heading">
            ...
            <h4>Basic Buffet Menu A</h4>
            <br>
            <li>Price: RM 20 / Pax</li>
            ...
            <h4>Menu Item</h4>
            <br>
            <li>Mains Selection (Choose 1)</li>
            ...
            <br>
            <li>Carbs Selection (Choose 1)</li>
            <li>- Nasi Kerabu</li>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <fieldset>
                  ...
                  <input type="number" id="budgetPerPax" name="budget_per_pax" min="0.01" step="0.01" value="20" oninput="calculateTotal()">
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
