...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <span class="breadcrumb"><a href="#">Home</a> / Request Quotation</span>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <fieldset>
                  ...
                  <input type="number" id="budgetPerPax" name="budget_per_pax" min="0.01" step="0.01" placeholder="Budget per Pax" oninput="calculateTotal()">
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                  <label for="pax">Number of Pax:</label>
                  <input type="number" id="pax" name="number_of_pax" min="1" placeholder="Number of Pax" oninput="calculateTotal()">
                </fieldset>
