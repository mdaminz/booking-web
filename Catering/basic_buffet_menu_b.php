...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <span class="breadcrumb"><a href="#">Home</a> / Basic Buffet Menu B</span>
          <h3>Basic Buffet Menu B</h3>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div style="width: 500px;" class="section-heading">
            ...
            <h4>Basic Buffet Menu B</h4>
            <br>
            <li>Price: RM 40 / Pax</li>
            <li>Min Pax: 30 Pax</li>
            <li>Serving Style: Buffet Setup with Warmers</li>
            <li>Menu Type: Malay</li>
            <li>Recommended For: Lunch/ Dinner, Birthday</li>
            <li>Setup Info: Food Delivery and Buffet Setup</li>
            <br>
            ...
            <h4>Menu Item</h4>
            <br>
            <li>Mains Selection (Choose 3)</li>
            <li>- Spicy Soy Chicken Popcorn, Kicap Pedas Style</li>
            <li>- Malaysian Style Beef Brisket Rendang</li>
            <li>- Pineapple Sweet & Sour Prawn</li>
            <li>- Crispy Nacho Chicken</li>
            <li>- Crispy Fish Finger Marinara</li>
            <br>
            <li>Garlic Stir Fried Vegetables & Mushrooms</li>
            <br>
            <li>Carbs Selection (Choose 2)</li>
            <li>- Nasi Kerabu</li>
            <li>- Butter Herb Rice</li>
            <li>- Spaghetti Aglio Olio</li>
            <li>- Mee Hoon Goreng</li><br>
            <li>Fresh Fruit of the Day</li>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <fieldset>
                  ...
                  <input type="number" id="budgetPerPax" name="budget_per_pax" min="0.01" step="0.01" value="40" oninput="calculateTotal()">
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                  ...
                  <p id="paxErrorMessage" style="color: red; display: none;">Minimum 30 Pax required.</p>
                </fieldset>
                </fieldset>
